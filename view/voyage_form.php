    ...
    <div class="container">
        ...
        <div class="row">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php 
         				$rows = query("SELECT a.id, d.ship_name, a.voyage_date, b.place origin, c.place dest, a.notes from voyage a, places b, places c, ship d where d.id = a.ship_id and a.origin = b.id and a.destination = c.id order by ship_name, voyage_date"); 
         				if (count($rows) > 0)
            			{
            				foreach ($rows as $row)
              				{
